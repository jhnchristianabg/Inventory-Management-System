        ...
        <body>
            <x-app-layout>
                ...
                <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-green-800 dark:border-gray-700">
                    ...
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Information Technology Service Inventory Management System</h5>
                ...
                <div class="flex justify-left my-5">
                    <div class="rounded-lg border border-[#332D2D] bg-white text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-black">
                        <div class="border-b-2 border-neutral-100 px-6 py-3 dark:border-black/20">
                            <b>Devices</b>
                            <a href="device"><button type="button" class="text-black-400 hover:text-black border border-yellow-200 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-yellow-300 dark:text-black-300 dark:hover:text-black dark:hover:bg-yellow-400 dark:focus:ring-yellow-200" style ="margin-left:25px">Add</button></a>
                            <a href="managementdevice"><button type="button" class="text-black-400 hover:text-black border border-yellow-200 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-yellow-300 dark:text-black-300 dark:hover:text-black dark:hover:bg-yellow-400 dark:focus:ring-yellow-200">Deploy</button></a>
                            <a href="managementdevice"><button type="button" class="text-black-400 hover:text-black border border-yellow-200 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-yellow-300 dark:text-black-300 dark:hover:text-black dark:hover:bg-yellow-400 dark:focus:ring-yellow-200">Pullout</button></a>
                        </div>
                    ...
                    <div class="flex justify-left" style ="margin-left:20px; float:right">
                        <div class="rounded-lg border border-[#332D2D] bg-white text-surface shadow-secondary-1 dark:bg-surface-dark dark:text-black">
                            <div class="border-b-2 border-neutral-100 px-6 py-3 dark:border-black/20">
                                <b>Consumables</b>
                                <a href="consumables"><button type="button" class="text-black-400 hover:text-black border border-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-yellow-300 dark:text-black-300 dark:hover:text-black dark:hover:bg-yellow-400 dark:focus:ring-yellow-900" style ="margin-left:25px">Add</button></a>
                                <a href="managementconsumables"><button type="button" class="text-black-400 hover:text-black border border-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-yellow-300 dark:text-black-300 dark:hover:text-black dark:hover:bg-yellow-400 dark:focus:ring-yellow-900">Deploy</button></a>
                            </div>
