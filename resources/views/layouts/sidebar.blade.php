...
<div :class="{ '!translate-x-0': open }" class="fixed top-0 left-0 z-20 w-9/12 h-screen overflow-y-auto transition duration-300 ease-in-out transform -translate-x-full bg-white shadow-2xl sm:w-64 md:translate-x-0">
    ...
    <div class="flex flex-col mb-0 ml-0">
        ...
        <x-sidebar-nav-link :active="request()->routeIs('device','cablesandperipherals','consumables')">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <ul id="dropdown-example" class="hidden">
                ...
                <a href="device" class="flex items-center px-4 py-3 text-lg md:text-sm w-full transition duration-300 ease-in-out hover:bg-green-700 hover:text-gray-100 text-black-800">Device</a>
                <a href="cablesandperipherals" class="flex items-center px-4 py-3 text-lg md:text-sm w-full transition duration-300 ease-in-out hover:bg-green-700 hover:text-gray-100 text-black-800">Cables & Peripherals</a>
                <a href="consumables" class="flex items-center px-4 py-3 text-lg md:text-sm w-full transition duration-300 ease-in-out hover:bg-green-700 hover:text-gray-100 text-black-800">Consumables</a>
            </ul>
        </x-sidebar-nav-link>
