<!doctype html>
    <html lang="en">
        <head>
            <title>ITS / Cables and Peripherals</title>
        </head>
        <body>
            <x-app-layout>
                <x-slot name="header">
                ...
                <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-yellow-500 dark:bg-yellow-500 dark:hover:bg-yellow-600 dark:focus:ring-yellow-500 float-right mx-1">
                    Pull Out
