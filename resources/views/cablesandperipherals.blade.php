    ...
    <html lang="en">
        ...
        <body>
            <x-app-layout>
                            ...
                            <form class="p-4 md:p-5" action="add_cp" method="POST">
                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="col-span-2 mt-5">
                                            ...
                                            <select name="CPType" id="CPType" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-30 p-2.5 dark:bg-gray-50 dark:border-gray-300 dark:placeholder-gray-400 dark:focus:ring-green-500 dark:focus:border-green-500"style="width:181px">
                                                <option name="CPType" value="Cable">Cable</option>
                                                <option name="CPType" value="Adapter">Adapter</option>
                                                <option name="CPType" value="Converter">Converter</option>
                                                <option name="CPType" value="Charger">Charger</option>
                                                <option name="CPType" value="Keyboard">Keyboard</option>
                                                <option name="CPType" value="Mouse">Mouse</option>
                                                <option name="CPType" value="AVR">AVR</option>
                                                <option name="CPType" value="Webcam">Webcam</option>
                                                <option name="CPType" value="Barcode Scanner">Barcode Scanner</option>
                                                <option name="CPType" value="Microphone">Microphone</option>
                                                <option name="CPType" value="Headset">Headset</option>
                                                <option name="CPType" value="Tripod">Tripod</option>
                                            </select>
                                        </div>
                                    <div class="col-span-2 sm:col-span-1 mt-5 ml-3">
                                            ...
                                            <input type="text" name="CPQuantity" id="CPQuantity" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-green-600 block w-30 p-2.5 dark:bg-gray-50 dark:border-gray-300 dark:placeholder-gray-400 dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Input Quantity">
                                        </div>
                                    </div>

                                    <div class="flex">
                                        <div class="col-span-2 sm:col-span-1 mt-3">
                                            <label for="CPID" class="block mb-2 text-sm font-semibold text-blueGray-900 uppercase">HOST ID</label>
                                    ...
                                    <div class="flex">
                                        <div class="col-span-2 sm:col-span-1 mt-3">
                                            ...
                                            <input type="text" name="CPBrand" id="CPBrand" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-green-600 block w-30 p-2.5 dark:bg-gray-50 dark:border-gray-300 dark:placeholder-gray-400 dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Input Brand" required="">
                                        </div>
                                        <div class="ml-3">
                                            <div class="col-span-2 sm:col-span-1 mt-3">
                                                <label for="CPModel" class="block mb-2 text-sm font-semibold text-blueGray-900 uppercase">Model</label>
                                                <input type="text" name="CPModel" id="CPModel" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-green-600 block w-30 p-2.5 dark:bg-gray-50 dark:border-gray-300 dark:placeholder-gray-400 dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Input Model" required="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex">
                                        <div class="col-span-2 sm:col-span-1 mt-3">
                                            <div>
                                                ...
                                                <select name="CPStatus" id="CPStatus" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-30 p-2.5 dark:bg-gray-50 dark:border-gray-300 dark:placeholder-gray-400 dark:focus:ring-green-500 dark:focus:border-green-500"style="width:181px">
                                                    <option name="CPStatus" value="Working">Working</option>
                                                    <option name="CPStatus" value="Not Working">Not Working</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                ...
                <!-- Search -->
                <form action="search_cp" method="GET">
                ...
                <!-- TABLE FOR CABLES AND PERIPHERALS VIEW-->
                    <div class="relative overflow-x-auto mt-14">
                        ...
                        <table id="dataTable" class="w-full text-xs text-left rtl:text-right font-light text-surface text-black ">
                            <thead class="text-xs uppercase bg-gray-200 font-bold">
                                <tr>
                                    <th scope="col" class="px-6 py-3">
                                        <a href="{{ route('cablesandperipherals.show', ['column' => 'id', 'direction' => ($column == 'id' && $direction == 'asc') ? 'desc' : 'asc']) }}">
                                            ID
                                            @if($column == 'id')
                                                @if($direction == 'asc')
                                    ...
                                    <th scope="col" class="px-6 py-3">
                                        <a href="{{ route('cablesandperipherals.show', ['column' => 'CPID', 'direction' => ($column == 'CPID' && $direction == 'asc') ? 'desc' : 'asc']) }}">
                                            HOST ID
                                            @if($column == 'CPID')
                                                @if($direction == 'asc')
                                                <svg class="w-4 h-4 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <th scope="col" class="px-6 py-3">
                                        <a href="{{ route('cablesandperipherals.show', ['column' => 'CPType', 'direction' => ($column == 'CPType' && $direction == 'asc') ? 'desc' : 'asc']) }}">
                                            Type
                                            @if($column == 'CPType')
                                                @if($direction == 'asc')
                                                <svg class="w-4 h-4 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <th scope="col" class="px-6 py-3">
                                        <a href="{{ route('cablesandperipherals.show', ['column' => 'CPName', 'direction' => ($column == 'CPName' && $direction == 'asc') ? 'desc' : 'asc']) }}">
                                            Name
                                            @if($column == 'CPName')
                                                @if($direction == 'asc')
                                                <svg class="w-4 h-4 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <th scope="col" class="px-6 py-3">
                                        <a href="{{ route('cablesandperipherals.show', ['column' => 'CPBrand', 'direction' => ($column == 'CPBrand' && $direction == 'asc') ? 'desc' : 'asc']) }}">
                                            Brand
                                            @if($column == 'CPBrand')
                                                @if($direction == 'asc')
                                                <svg class="w-4 h-4 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <th scope="col" class="px-6 py-3">
                                        <a href="{{ route('cablesandperipherals.show', ['column' => 'CPModel', 'direction' => ($column == 'CPModel' && $direction == 'asc') ? 'desc' : 'asc']) }}">
                                            Model
                                            @if($column == 'CPModel')
                                                @if($direction == 'asc')
                                                <svg class="w-4 h-4 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <th scope="col" class="px-6 py-3">
                                        <a href="{{ route('cablesandperipherals.show', ['column' => 'CPQuantity', 'direction' => ($column == 'CPQuantity' && $direction == 'asc') ? 'desc' : 'asc']) }}">
                                            Quantity
                                            @if($column == 'CPQuantity')
                                                @if($direction == 'asc')
                                                <svg class="w-4 h-4 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" />
                                                </svg>
                                    ...
                                    <th scope="col" class="px-6 py-3">
                                        <a href="{{ route('cablesandperipherals.show', ['column' => 'CPStatus', 'direction' => ($column == 'CPStatus' && $direction == 'asc') ? 'desc' : 'asc']) }}">
                                            Status
                                            @if($column == 'CPStatus')
                                                @if($direction == 'asc')
                                                <svg class="w-4 h-4 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <th scope="col" class="px-6 py-3">
                                        <a href="{{ route('cablesandperipherals.show', ['column' => 'CPRemarks', 'direction' => ($column == 'CPRemarks' && $direction == 'asc') ? 'desc' : 'asc']) }}">
                                            Remarks
                                            @if($column == 'CPRemarks')
                                                @if($direction == 'asc')
                                                <svg class="w-4 h-4 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <tbody>
                                @foreach($cpview as $cables_and_peripherals)
                                <tr class="bg-white border-b dark:border-gray-300 text-black">
                                    <td class="px-6 py-4">{{$cables_and_peripherals->id}}</td>
                                    <td class="px-6 py-4 font-bold uppercase">{{$cables_and_peripherals->CPID}}</td>
                                    <td class="px-6 py-4">{{$cables_and_peripherals->CPType}}</td>
                                    <td class="px-6 py-4">{{$cables_and_peripherals->CPName}}</td>
                                    <td class="px-6 py-4">{{$cables_and_peripherals->CPBrand}}</td>
                                    <td class="px-6 py-4">{{$cables_and_peripherals->CPModel}}</td>
                                    <td class="px-6 py-4">{{$cables_and_peripherals->CPQuantity}}</td>
                                    <td class="px-6 py-4 font-bold uppercase text-xs">{{$cables_and_peripherals->CPStatus}}</td>
                                    <td class="px-6 py-4">{{$cables_and_peripherals->CPRemarks}}</td>
                                    <td class="px-6 py-4">
                                        <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-3">
                                        <button type="button" onclick="location.href='{{ url('cpdetails/'.$cables_and_peripherals->id) }}'">
                                        ...
                                        <button type="button" onclick="location.href='{{ url('cpedit/'.$cables_and_peripherals->id) }}'">
                                        ...
                                        <form method="POST" action="{{ route('cp.soft-delete', ['id' => $cables_and_peripherals->id]) }}">
                                            @csrf
                                            @method('DELETE')
                        ...
                        <div class="mt-3">
                            {{ $cpview->appends(['column' => $column, 'direction' => $direction])->links() }}
                        </div>
